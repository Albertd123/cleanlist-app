        ...
        if not st.session_state.item_list:
            ...
            for item_index, item_dict in enumerate(st.session_state.item_list):
                ...
                for brand in brand_list:
                    ...
                    score = score_item(brand, ingredients)[0]
                ...
                for i, (brand, score, ingredients) in enumerate(brand_scores):
                    ...
                    if i == 0:
                        ...
                        padding = 20 + int(normalized * 20)
                        font_size = 1.0 + normalized * 0.4
                        shadow_strength = 0.08 + normalized * 0.17
                    ...
                    html_block = (
                        ...
                        f"min-width: 300px; max-width: 400px; margin-bottom: 25px; box-shadow: 0 2px 8px rgba(0,0,0,{shadow_strength}); border: {border_style}; transition: all 0.3s ease;'>"
                        f"{top_badge}"
